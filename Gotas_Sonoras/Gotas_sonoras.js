//Gotas sonoras
//Experimentos by Rute Maxsuelly - Visualizando Oscilador
// Contém um envelope com som de ataque, decaimento, sustentação e release.
// Baseado em https://www.openprocessing.org/sketch/742076
...
function draw() {
  ...
  if(points.length==0){
    fill(255);
    text("CLIQUE E OUÇA GOTAS SONORAS", center.x, center.y);
    return;
  }
