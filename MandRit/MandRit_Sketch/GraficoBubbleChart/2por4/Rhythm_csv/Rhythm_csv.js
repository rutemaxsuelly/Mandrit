...
function preload(){
  airData = loadTable("Plotar_Musicas2por4/SambadeUmanotaso_2por4.csv",
    "csv",
    "header");
    
     sound = loadSound('ArquivoMusicas2por4/Samba_De_Uma_Nota_So.mp3');
  ...
  textFont(font);
   strokeWeight(1);
        ...
        //verticais//
                ...
                text('Fórmula do Compasso: 2/4', 1430, 660, width); //5/4 ou 2/4 ou 3/4...
                textSize(30);
                text('-', 1400, 580, width);
               text('+', 1750, 580, width);
...
function drawCirclefundo(){
  ...
  //Opção Nogrid:
    ...
    circles = 2; ////16 para músicas 2/4; 32 para 3/4;  64 para 4/4; //TakeaFive 5/4(4/4 + 1/4de64) = 80 times 
...
function textos(){
        ...
        text(' Track 2 = Baixo', 620, -280, width);
        text(' Track 3 = Flautas', 620,-260 , width);
        text(' Track 4 = Piano', 620, -240, width);
       text(' Track 5 = Cordas', 620, -220, width);
        text(' Track 6 = Percussão', 620, -200, width);  
