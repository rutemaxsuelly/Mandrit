//MANDRIT - Análise rastros por quantidade de notas em função de raio circulo
...
function preload(){
  airData = loadTable("csv_plot/chao-de-gizZeRamalhoTipo1.csv",
    "csv",
    "header");
}
...
/////LEGENDAS E REFERÊNCIAS GRAPHO////////
  stroke(1);
        ...
        text('Sequência Temporal', 200, 450, width);
